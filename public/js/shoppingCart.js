...
// set cart name in localStorage
shoppingCart.prototype.setCartName = function (cartName) {
    if (localStorage != null && cartName != null)
...
shoppingCart.prototype.getTotalItemsCount = function () {
...
shoppingCart.prototype.checkoutPayPal = function (parms, clearCart) {
    ...
    var data = {
        ...
        upload: "1",
        return: "http://aqueous-beach-23990.herokuapp.com/api/paypal/success",
        rm: "2",
        lc: "he_IL",
        currency_code: "ILS",
        charset: "utf-8"
    ...
    for (var i = 0; i < this.items.length; i++) {
        ...
        data["item_name_" + ctr] = item.quantity + ' ק"ג ' + item.name;
    ...
    //this.addFormFields(form, csrf);
    this.addFormFields(form, parms.options);
    console.log("ShoppinCart: " + parms.options)
    $("body").append(form);
